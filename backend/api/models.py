...
class Profile(models.Model):
    full_name = models.CharField(max_length=150, default="Alex Morgan")
    ...
    hero_headline = models.CharField(max_length=250, default="Crafting exceptional digital experiences through code & design.")
    hero_subheading = models.CharField(max_length=300, default="Specializing in modern web applications, design systems, and seamless user interfaces.")
    avatar = models.ImageField(upload_to="profile/", blank=True, null=True)
    avatar_url = models.CharField(max_length=500, blank=True, default="")
    resume_file = models.FileField(upload_to="resume/", blank=True, null=True)
    resume_url = models.CharField(max_length=500, blank=True, default="")
    email = models.EmailField(default="alex.morgan@example.com")
    phone = models.CharField(max_length=50, blank=True, default="+1 (555) 234-5678")
